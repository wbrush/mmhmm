...
import (
	...
	sw "github.com/wbrush/go-common/ui-swagger"
	"github.com/wbrush/mmhmm/configuration"
	"github.com/wbrush/mmhmm/dao"
)
...
func NewAPI(cfg *configuration.Config, swaggerPath string, dao dao.DataAccessObject) *API {
	api := &API{
		config: cfg,
